  ...
  return (
    <div className='py-0 px-2.5 pb-25'>
        <div className='max-w-xl my-20 mx-auto flex flex-col items-center text-center gap-7'>
            ...
            <form className='p-2 w-[80%] bg-white rounded text-[20px] flex justify-between items-center gap-2.5'>
                <input className='text-black flex-1 text-base outline-none pl-2.5 w-25 sm:w-full' type="text" placeholder='Search crypto..' />
        ...
        <div className="max-w-[800px] m-auto bg-[linear-gradient(rgba(84,3,255,0.15),rgba(105,2,153,0.15))] rounded-2xl">
            ...
            </div>
            {
                displayCoin.slice(0,10).map((item, index)=>(
                    <div key={index} className="grid grid-cols-[0.5fr_minmax(0,3fr)_minmax(0,1fr)_minmax(0,1fr)] md:grid-cols-[0.5fr_minmax(0,2fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1.5fr)]  py-4 px-5 items-center border-1 border-b-[#3c3c3c] text-[13px] sm:text-base ">
